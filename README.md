...
Every package in your supply chain, and your agent, runs with full access to your computer (by default) and the auth tokens that let you interact with github and many other services.
