...
#   dev/test-stack/flake.lock, tests/lib/flake.lock
...
mkdir -p "$tmp/dev/test-stack" "$tmp/tests/lib" "$tmp/std/bash" "$tmp/std/cargo" "$tmp/std/flake-builder" "$tmp/std/git-runner" "$tmp/std/merge"
derive_lock "$tmp/std/bash/flake.lock" nixpkgs
derive_lock "$tmp/dev/test-stack/flake.lock" nixpkgs
derive_lock "$tmp/tests/lib/flake.lock" nixpkgs
