...
double=$("$CAOS_CLI" curry /cas/std/bash -- --worker1:@=test/double.sh)
combine=$("$CAOS_CLI" curry /cas/std/bash -- --worker1:@=test/combine.sh)
...
cyc=$("$CAOS_CLI" curry /cas/std/bash -- --worker1:@=test/cycle.sh)
